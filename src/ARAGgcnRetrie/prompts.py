...
def create_uua_gcn_prompt(long_term_context,current_session, gcn_behavior_insight : str) -> str:
    template = _manager.get_template('user_understanding_gcn')
    return template.format(long_term_context=long_term_context, current_session=current_session, gcn_behavior_insight = gcn_behavior_insight)